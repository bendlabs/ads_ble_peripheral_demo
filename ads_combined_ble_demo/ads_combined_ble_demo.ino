...
#define DEMO_DEVICE_ONE_AXIS    (1)       // Set to 0 for two axis
...
void setup() {
  ...
  Serial.print(model_str);
  Serial.println(" Angular Displacement Sensor");                        
  ...
  {
    Serial.print(model_str);
    Serial.print(" initialization failed with reason: ");
